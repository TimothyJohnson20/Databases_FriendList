...
//                startActivity(createAccountIntent);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CREATE_ACCOUNT)
        {
            ...
            {
                //  use the intent from the parameter to extract the username and password and prefill them into the edittext fields here
                String eUsername = data.getStringExtra(RegistrationActivity.EXTRA_USERNAME);
                String ePassword = data.getStringExtra(RegistrationActivity.EXTRA_PASSWORD);
                editTextUsername.setText(eUsername);
                editTextPassword.setText(ePassword);
            }
        }
    }
